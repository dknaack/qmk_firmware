...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_dknaack(
         ...
         _______,KC_LBRC,ALT_4  ,SFT_5  ,CTL_6  ,KC_RBRC,       _______,KC_LCTL,KC_LSFT,KC_LALT,KC_LGUI,QK_BOOT,
    ...
    [2] = LAYOUT_dknaack(
        _______,_______,_______,_______,_______,_______,        _______,_______,_______,_______,_______,_______,
        _______,_______,_______,_______,_______,_______,        KC_CIRC,KC_AMPR,KC_ASTR,KC_PIPE,KC_AT  ,_______,
        _______,KC_LGUI,KC_LALT,KC_LSFT,KC_LCTL,_______,        KC_HASH,KC_MINS,KC_PLUS,KC_EXLM,KC_GRV ,_______,
        _______,_______,_______,_______,_______,_______,        KC_TILD,KC_PERC,KC_LT  ,KC_GT  ,KC_BSLS,_______,
        _______,_______,_______,_______,_______,_______,        _______,_______,_______,_______,_______,_______,
                                        _______,_______,        _______,_______,
                                                _______,        _______,
    ...
    [4] = LAYOUT_dknaack(
         ...
         _______,KC_F11 ,KC_F4  ,KC_F5  ,KC_F6  ,KC_NO  ,       _______,_______,_______,_______,_______,QK_BOOT,
         _______,KC_F10 ,KC_F1  ,KC_F2  ,KC_F3  ,KC_NO  ,       _______,_______,_______,_______,_______,_______,
         _______,_______,_______,_______,_______,_______,       _______,_______,_______,_______,_______,_______,
                                         _______,_______,       _______,_______,
                                                 _______,       _______,

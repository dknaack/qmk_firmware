...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_dknaack(
         ...
         _______,KC_PLUS,KC_7   ,KC_8   ,KC_9   ,_______,       _______,_______,_______,_______,_______,_______,
         _______,GUI_MIN,ALT_4  ,SFT_5  ,CTL_6  ,_______,       _______,_______,_______,_______,_______,QK_BOOT,
